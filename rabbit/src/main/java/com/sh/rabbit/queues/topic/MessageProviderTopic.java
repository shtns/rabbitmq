package com.sh.rabbit.queues.topic;
 ...
 */
public class MessageProviderTopic {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //声明交换机名称
        String exchangeName = "exchage_topic";
        ...
        //参数4：消息内容
        channel.basicPublish(exchangeName, "one.two.three", MessageProperties.PERSISTENT_TEXT_PLAIN,
                "hello rabbitmq topic".getBytes(StandardCharsets.UTF_8));
